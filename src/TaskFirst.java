public class TaskFirst {
    ...
    public boolean L1T2(int xTemp, int yTemp){
        double[] start1 = new double[] {-4, 0};
        double[] end1 = new double[] {4, 5};

        double[] start2 = new double[] {-6, -3};
        double[] end2 = new double[] {6, 0};

        if ((xTemp>=start1[0] && xTemp<=end1[0])&&(yTemp>=start1[1] && yTemp<=end1[1])){
            return true;
        } else if ((xTemp>=start2[0] && xTemp<=end2[0])&&(yTemp>=start2[1] && yTemp<=end2[1])){
            return true;
        } else return false;
    }
