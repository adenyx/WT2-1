...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Book myBook = new Book("Builds in Minecraft", "Zet",23,0);
        ...
        myLibruary.add(new Book("Saygon", "Ho Chi Minh",65,2));
        myLibruary.add(new Book("South Korea", "Li sun man",51,3));
        myLibruary.add(new Book("LEA", "Valluy",47,1));
        ...
        myLibruary2.add(new Book("A Saygon", "Ho Chi Minh",65,2));
        myLibruary2.add(new Book("South Korea", "Li sun man",51,3));
        myLibruary2.add(new Book("A LEA", "Valluy",47,1));
        ...
        myLibruary3.add(new Book("A Saygon", "Ho Chi Minh",65,2));
        myLibruary3.add(new Book("South Korea", "Li sun man",51,3));
        myLibruary3.add(new Book("A LEA", "Valluy",47,1));
        ...
        myLibruary4.add(new Book("A Saygon", "Ho Chi Minh",65,2));
        myLibruary4.add(new Book("South Korea", "Li sun man",51,3));
        myLibruary4.add(new Book("A LEA", "Valluy",47,1));
